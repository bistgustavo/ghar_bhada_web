                  ...
                  {rooms.map((room) => (
                    <tr key={room.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right space-x-2">
                        ...
                        <Button size="xs" variant="ghost" onClick={() => navigate(`/landlord/rooms/${room.id}/photos`)}>Photos</Button>
                        <Button size="xs" variant="ghost" onClick={() => navigate(`/landlord/rooms/${room.id}/amenities`)}>Amenities</Button>
                        <Button size="xs" variant="ghost" onClick={() => navigate(`/landlord/rooms/${room.id}/subscriptions`)}>Subs</Button>
              ...
              {rooms.map((room) => (
                <div key={room.id} className="p-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate(`/rooms/${room.id}`)}>View</Button>
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate(`/landlord/rooms/${room.id}/photos`)}>Photos</Button>
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate(`/landlord/rooms/${room.id}/amenities`)}>Amenities</Button>
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate(`/landlord/rooms/${room.id}/subscriptions`)}>Subs</Button>
                    <Button size="sm" variant="danger" className="flex-1" onClick={() => setDeleteModal({ open: true, room })}>Delete</Button>
                  </div>
                </div>
              ))}
            </div>
